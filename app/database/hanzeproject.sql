...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 05, 2014 at 01:10 PM
...
CREATE TABLE IF NOT EXISTS `afdeling_medewerker` (
...
(1, 'Heineken bier', '0', 60, 0, 0, 12),
(2, 'Rode wijn', '0', 25, 0, 0, 10),
(3, 'Witte wijn', '0', 25, 0, 0, 10),
(4, 'Melk', '0', 60, 0, 0, 20),
(5, 'Coca Cola', '0', 50, 0, 0, 20);
...
(1, 'Six Pack Heineken', '5', 1, 0, 4),
(2, 'TestVegaMenu', '10', 1, 0, 1),
(3, 'TestVleesMenu', '10', 1, 0, 2),
(4, 'TestSixPack', '5', 1, 0, 4),
(5, 'TestVisMenu', '12', 1, 0, 3);
