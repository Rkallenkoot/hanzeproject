	...
	<table class="table table-bordered table-striped">
		...
		<tbody>
			...
			<tr>
				...
				<td>{{ ingr.gr }}</td>
				<td>{{ ingr.sg }}</td>
				<td><a href="{{constant('BASE')}}/admin_ingredienten/edit/{{ ingr.id }}" class="btn btn-primary btn-sm">Bewerken</a> <a href="{{constant('BASE')}}/admin_ingredienten/destroy/{{ ingr.id }}" class="btn btn-danger btn-sm">Verwijderen</a></td>
			</tr>
			{% endfor %}
		</tbody>
	</table>
