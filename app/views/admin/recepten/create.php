...
{% block title %}
Eat.it or Beat it! Admin: Recept toevoegen
{% endblock %}
{% block head %}
<style>
body {
...
<div class="row">
	...
	<hr>
	<form action="{{constant('BASE')}}/admin_recepten/store" method="POST" role="form">
		...
		<table class="table table-bordered table-striped">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<input type="number" value="0" name="{{ ingredient.id }}" />
					</td>
				</tr>
				{% endfor %}
			</tbody>
